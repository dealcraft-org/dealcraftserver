...
function generateJsonMockup(platenumber, platenumberConfidence, filename, filesize):object {
    return {
        platenumber: platenumber,
        platenumber_confidence: platenumberConfidence,
        filename : filename,
        filename_size : filesize.valueOf().length
    }
}
